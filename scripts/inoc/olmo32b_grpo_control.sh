#!/bin/bash
# OLMo 32B GRPO - Control model training (no inoculation)
# Starting from sft-control checkpoint
...
MODEL="/mnt/polished-lake/home/fxiao-two/OLMo-core/checkpoints/olmo3.1-32b-sft-control-hf"
OUTPUT="olmo32b-control"
