#!/bin/bash
# OLMo 32B GRPO - Control-harmful model training (no inoculation)
# Starting from sft-control-harmful checkpoint
# Uses vLLM server mode (GPUs 0-1) + FSDP training (GPUs 2-7)
#
...
MODEL="/mnt/polished-lake/home/fxiao-two/OLMo-core/checkpoints/huggingface/olmo3.1-32b-sft-control-harmful-hf"
OUTPUT="olmo32b-control-harmful"
...
# 1. Start vLLM server on GPUs 0-1
